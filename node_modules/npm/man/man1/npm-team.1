...
\fB\fP team on a \fB\fP organization, you must always refer to that team as
\fB\fP in these commands\.
.RS 0
.IP \(bu 2
create / destroy:
...
.SH DETAILS
.P
\fB\fP always operates directly on the current registry, configurable from
the command line using \fB\fP\|\.
.P
...
use the \fB\fP command to grant or revoke the appropriate permissions\.
.SH SEE ALSO
.RS 0
.IP \(bu 2
npm help access
